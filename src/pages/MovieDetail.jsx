...
export default function MovieDetail() {
  ...
  if (!detailFilm) {
    return (
      <div className="text-center mt-32 text-slate-400">
        ...
        <Link
          to="/"
          className="inline-block mt-6 bg-slate-800 hover:bg-slate-700 px-6 py-2 rounded-full font-bold text-white transition-colors"
        >
  ...
  return (
    <div className="w-full pb-10">
      <Link
        to={-1}
        className="inline-flex items-center gap-2 text-slate-400 hover:text-white transition-colors mb-6 group bg-slate-800/50 hover:bg-slate-800 px-4 py-2 rounded-lg w-fit ml-4"
      >
        <FontAwesomeIcon
          icon={faArrowLeft}
          className="group-hover:-translate-x-1 transition-transform"
        />
        <span className="group-hover:scale-105 transition-transform font-semibold">
          Kembali
        </span>
      </Link>
        ...
        <div className="flex flex-col grow min-w-0">
          ...
          {trailer && (
            <div className="mt-auto pt-4">
              <a
                ...
                className="inline-flex items-center gap-3 bg-blue-600 hover:bg-blue-700 text-white font-bold px-8 py-4 rounded-xl transition-all hover:scale-105 active:scale-95 shadow-lg shadow-blue-900/50 animate-pulse "
              >
          ...
          <div className="mt-4 mb-8">
            <button
              ...
              className={`cursor-pointer inline-flex items-center gap-3 font-bold px-8 py-4 rounded-xl transition-all hover:scale-105 active:scale-95 shadow-lg font-poppins ${
                isFavorite
                  ? "bg-red-600 text-white hover:bg-red-700 shadow-lg shadow-red-900/50"
                  : "bg-emerald-600 text-white hover:bg-emerald-700 shadow-lg shadow-emerald-900/50"
              }`}
            >
              <svg
